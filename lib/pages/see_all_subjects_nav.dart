...
class SeeAllSubNav extends StatefulWidget{

  final String pageText;

  //const ProfilePage({Key key, this.pageText}): super(key: key);
  SeeAllSubNav(this.pageText, {Key key}): super(key: key);

  @override
  _SeeAllSubNav createState() => _SeeAllSubNav();
...
class _SeeAllSubNav extends State<SeeAllSubNav>{
