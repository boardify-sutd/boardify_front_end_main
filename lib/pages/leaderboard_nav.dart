...
class LeaderboardNav extends StatefulWidget{
  ...
  LeaderboardNav(this.pageText, {Key key}): super(key: key);

  @override
  _LeaderboardNav createState() => _LeaderboardNav();
...
class _LeaderboardNav extends State<LeaderboardNav>{
